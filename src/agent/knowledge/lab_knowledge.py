...
LAB_DESCRIPTION = """
El Laboratorio de FrED Factoryes una instalación de producción automatizada con sede 
en el Tecnológico de Monterrey y en el MIT.Combina robots colaborativos (cobots),
 controladores lógicos programables (PLCs)y sistemas de visión artificial 
 para realizar procesos de ensamblaje, inspección
y empaque de productos electrónicos.

El laboratorio está diseñado para demostrar conceptos de Industria 4.0 y 5.0, incluyendo:
...
LAB_PURPOSE = """
Esta desarrollado para enseñarle a los estudiantes de la Facultad de
Ingen
"""
