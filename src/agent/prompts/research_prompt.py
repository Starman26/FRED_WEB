...
Tu objetivo es decidir si esta consulta necesita búsqueda en documentos técnicos internos:

- 'rag': Si la consulta se refiere a manuales, papers, documentos internos, procedimientos de laboratorio, normativas o investigación académica.
- 'skip': Si la consulta NO necesita documentos técnicos. Ejemplos: ayuda con código, CSS, prompts, conversación general, opiniones, diseño UI, programación, emociones.

Responde SOLO con una palabra: 'rag' o 'skip'.
"""
